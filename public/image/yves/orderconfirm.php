...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $youReceiveValue = $_POST["youRecieveValue"];
        $youSendId = $_POST["youSendId"];
        $youReceiveId = $_POST["youReceiveId"];
        $recipientWallet  = $_POST["recipientWallet"];
        echo $data;
}
?>
<!DOCTYPE html>
                                ...
                                <div class="col-md-8 col-lg-7 " id="tab1">
                                        <div class="set-transaction-step exchange-stepper--step exchange-stepper--panel">
                                                <div class="set-transaction-step--content">
                                                        <h1 class="exchange-stepper--attention-title">Please confirm the details of your Exchange</h1>
                                                        <div class="exchange-calculator exchange-calculator__light">
                                                                <div>
                                                                        <p class="now-input--label" for="youSendInput">You Send</p>
                                                                        <p style="margin-top: 20px;font-size: 30px;color: black;font-weight: 900;"><span id="youSendValue"><?php echo $youSendValue ?></span><span id="youSend"><?php echo $youSendId ?></span></p>
                                                                </div>
                                                        </div>
                                                        <p>
                                                                1<span id="conversionRateFrom"><?php echo $youSendId ?></span> ~
                                                                <span id="conversionRate">...</span>
                                                                <span id="conversionRateTo"><?php echo $youReceiveId ?></span>
                                                                </span>
                                                        </p>
                                                        <div class="exchange-calculator exchange-calculator__light">
                                                                <div>
                                                                        <p class="now-input--label" for="youSendInput">You Get</p>
                                                                        <p style="margin-top: 20px;font-size: 30px;color: black;font-weight: 900;"><span id="youReceiveValue"><?php echo $youReceiveValue ?></span><span id="youReceive"><?php echo $youReceiveId ?></span></p>
                                                                </div>
                                                        </div>
                                                        <p><?php echo  $recipientWallet ?></p>
                                                        <br /><br />
                                                        <div class="exchange-calculator exchange-calculator__light">
                                                                <div>
                                                                        <p class="now-input--label" for="youSendInput">Estimated Arrival</p>
                                                                         <p>~10  minutes</p>
                                                                </div>
                                                        </div>
                                                ...
                                                <div class="new-stepper-recipient-field exchange-stepper--input">
                                                        <div class="new-stepper-field-qr-code">
                                                                <div class="new-stepper-field">
                                                                        ...
                                                                        <div class="new-stepper-field__wrapper-input"><input type="text" id="recipientWallet" class="new-stepper-field__input" placeholder="Enter the payout address" value="" spellcheck="false" /><span class="new-stepper-field__placeholder" id="spanWallet">Enter the ETH payout address</span>
                                                ...
                                                </div><button type="button" onclick="changeTab(1)" class="now-button now-button__green exchange-stepper--next-button">Next</button>
                                        </div>
                                </div>
                        </div>
