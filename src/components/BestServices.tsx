...
const BestServices: React.FC = () => {
        return (
                <div className='px-[5vw] py-12 flex flex-row w-full gap-10 '>
                        ...
                        <div className='w-[50%]'>
                                <p className='text-[1.4vw] text-[rgba(0,0,0,0.4)] capitalize my-2'>Why choose Us</p>
                                <p className='text-[3.8vw] font-medium my-2'>Best services provided by Hoode</p>
                                <p className='text-[1.7vw] text-[rgba(0,0,0,0.4)] font-medium my-4'>Lorem ipsum dolor sit amet consectetur. Felis facilisis amet ornare sagittis vestibulum nibh nulla facilisis vel. Orci in et vitae tellus. orem ipsum.  vestibulum nibh nu Lorem ipsum dolor sit amet consectetur. Felis facilisis amet ornare sagittis vestibulum nibh nulla facilisis vel. Orci in et vitae tellus. orem ipsum.  vestibulum nibh nu</p>
                                <button className='bg-[#232323] rounded-full px-[3vw] py-[1vh] text-white text-[1.7vw]'>Learn more</button>
                        </div>
                        <div className="grid-box text-[1.7vw] ">
