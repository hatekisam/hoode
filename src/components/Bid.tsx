                        ...
                        <div className='rounded-md w-full text-white bg-[#232323] px-[4vw] py-[4.5vw] relative'>
                                ...
                                <div className="w-[100%] flex flex-row justify-between">
                                        ...
                                        <div className='w-[50%]'>
                                                ...
                                                <p className=' text-[4vw] md:text-[3.8vw] font-medium my-[2vh]'>Simply Bid,Your home, expertly served</p>
                                                <p className='font-medium text-[rgba(255,255,255,0.4)] my-[2vh] text-[2.2vw] md:text-[1.7vw]'>Lorem ipsum dolor sit amet consectetur. Felis facilisis amet ornare sagittis vestibulum nibh nulla facilisis vel. Orci in et vitae tellus. orem ipsum.  </p>
